...
PreparedStatement ps2=con.prepareStatement("SELECT MAX(qno) AS tq  from DotnetQ ");
...
PreparedStatement pst=con.prepareStatement("select  * from DotnetQ where qno=?  ORDER BY qno ASC ");
...
while(rs.next())
{
	...
	<h3><font color="brown" > <p align="center">.Net Exam Result </p></font> </h3>
