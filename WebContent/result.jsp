...
try
{
    ...
    PreparedStatement pst22=con.prepareStatement("SELECT MAX(qno) AS tq  from TestingQ ");

	ResultSet rss = pst22.executeQuery();
	int max=0;
...
while(rs.next())
{
	...
	%>
	<h3><font color="brown" > <p align="center">Testing Exam Result </p></font> </h3>
