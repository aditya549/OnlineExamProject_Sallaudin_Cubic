...
String select=request.getParameter("course");

HttpSession h5=request.getSession();
h5.setAttribute("se", select);
  ...
  <div class="courses_banner">
	...
	<div class="courses_box1">
	   <div class="container">
	    	...
	    	<p class="lead"><u>User Login </u></p>
			<fieldset>
		    <div class="form-group">
			    <input autocomplete="off" type="text" name="un" class="required form-control" placeholder="Username"  required>
		    </div>
		    <div class="form-group">
			    <input autocomplete="off" type="password" class="password required form-control" placeholder="Password" name="pwd"  required>
		    </div>
		    
		    <div class="form-group">
		        <input type="hidden" name="hide" value="user">
		    	<input type="checkbox" name="remember" value="true"> Remember Me
		    	<input type="submit" class="btn btn-primary btn-lg1 btn-block" name="submit" value="Log In">
		    </div>
			</fieldset>
	        <p>Don't have an account? <a href="register.jsp" title="Sign Up">Sign Up</a></p>
		 </form>
	   </div>
	</div>
    <div class="footer">
