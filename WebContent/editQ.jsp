...
PreparedStatement pst=conn.prepareStatement("select * from TestingQ where qno=? ");
pst.setInt(1, qn);
...
Question  &nbsp&nbsp &nbsp&nbsp&nbsp<input type="text" size="80%"  name="qu" value="<%=rs.getString(2) %>"><br><br>
Option 1  &nbsp&nbsp &nbsp&nbsp&nbsp<input type="text" size="80%"  name="o1" value="<%=rs.getString(3) %>"><br><br>
Option 2  &nbsp&nbsp &nbsp&nbsp&nbsp<input type="text" size="80%"  name="o2" value="<%=rs.getString(4) %>"><br><br>
Option 3  &nbsp&nbsp &nbsp&nbsp&nbsp<input type="text" size="80%"  name="o3" value="<%=rs.getString(5) %>"><br><br>
Option 4  &nbsp&nbsp &nbsp&nbsp&nbsp<input type="text" size="80%"  name="o4" value="<%=rs.getString(6) %>"><br><br>
