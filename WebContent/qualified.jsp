    ...
    <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
        <ul class="nav navbar-nav nav_1">
		   ...
		   <li class="dropdown">
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Activites<span class="caret"></span></a>
               <ul class="dropdown-menu" role="menu">
                <li><a href="mailS.jsp">Send Mail</a></li>
                 <li><a href="deletehere.jsp">Delete</a></li>
...
try
{
	...
	<br>
	    ...
	    &nbsp   &nbsp <h3>    <p align="center" color="blue"> <u> Qualified List </u>  </p>  </h3>  
	...
	<br>
	<br>
	<table border="2px" width="1100" align="center"  >
	...
	<thead>
	       ...
	       <thead>
	                      ...
	                      <th> &nbsp &nbsp Year of Passout</th>
	                      <th> &nbsp &nbsp Phone Number</th>
	                      <th> &nbsp &nbsp course</th>
...
%>
	 ...
	 <tr>       <td > &nbsp &nbsp  <%=rs.getString(1)  %> &nbsp &nbsp <%= rs.getString(2) %> </td>     
	            ...
	            <td> &nbsp &nbsp  <%=rs.getString(7) %> </td> 
	             <td> &nbsp &nbsp  <%=rs.getString(10) %> </td> 
	            <td> &nbsp &nbsp  <%=rs.getString(8) %> </td> 
	             <td> &nbsp &nbsp  <%=rs.getString(11) %> </td> 
	...
	<% 
	 	PreparedStatement pst6=con.prepareStatement("select * from UserDetails where result=? ");
	    	pst6.setString(1,"DisQualified");
	...
	<br>
	    ...
	    &nbsp   &nbsp <h3>    <p align="center" color="blue"> <u> DisQualified List </u>  </p>  </h3>  
...
%>
	 ...
	 <tr>       <td > &nbsp &nbsp  <%=rs1.getString(1)  %> &nbsp &nbsp <%= rs1.getString(2) %> </td>     
	            <td> &nbsp &nbsp  <%=rs1.getString(3) %> </td> 
	           
	            <td> &nbsp &nbsp  <%=rs1.getString(5) %> </td> 
	            <td> &nbsp &nbsp <%=rs1.getString(6) %> </td> 
	            <td> &nbsp &nbsp  <%=rs1.getString(7) %> </td> 
	              <td> &nbsp &nbsp  <%=rs1.getString(10) %> </td> 
	            <td> &nbsp &nbsp  <%=rs1.getString(8) %> </td> 
	            <td> &nbsp &nbsp  <%=rs1.getString(11) %> </td> 
	             <td> &nbsp &nbsp  <%=rs1.getString(9) %> </td> 
