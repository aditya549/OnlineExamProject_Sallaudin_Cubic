...
<h1>   Add Java Questions  </h1>
</div>
<form class="form-horizontal" role="form" method="post" action=" JavaQuestions">
...
<div class="col-sm-6">
<input type="text" name="qn" class="form-control"  required>
</div>
</div>
 
<div class="form-group">
<label for="lastName" class="col-sm-2 control-label">Option 1 :</label>
<div class="col-sm-6">
<input type="text" name="1" class="form-control" id="lastName"  required>
</div>
</div>
 
  
<div class="form-group">
<label for="userName" class="col-sm-2 control-label">Option 2 :</label>
<div class="col-sm-6">
<input type="text" name="2" class="form-control" id="userName"  required>
</div>
</div>

  
<div class="form-group">
<label for="userName" class="col-sm-2 control-label">Option 3 :</label>
<div class="col-sm-6">
<input type="text" name="3" class="form-control" id="userName"  required>
</div>
</div>

  
<div class="form-group">
<label for="userName" class="col-sm-2 control-label">Option 4 :</label>
<div class="col-sm-6">
<input type="text" name="4" class="form-control" id="userName"  required>
</div>
</div>
 
   
<div class="form-group">
<label for="userName" class="col-sm-2 control-label">Answer  :</label>
<div class="col-sm-6">
<input type="text" name="an" class="form-control" id="userName"  required>
</div>
</div>
...
All about gearing blooming businesses with best services of designing, developing and securing IT. Bringing customers ideas to life.</p>
