...
<!-- banner -->
  <div class="courses_banner">
	...
	<div class="courses_box1">
	   <div class="container">
	   	  <form class="login" action="selectPage.jsp" method="post">
	    	<p class="lead"><u>Login Selection</u></p>
			
			<fieldset>
			   <input type="radio"id="Employee" value="EmpId"name="login" checked> 
               <label><big> User Login</big></label> 
               
		  &nbsp &nbsp   <input type="radio"id="Admin" value="Admin"name="login" >
             <label><big><b></b>Admin Login</b></big></label> 
