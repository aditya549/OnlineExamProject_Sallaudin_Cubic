...
<table border="2px" width="95%" color="blue">
 ...
 %>
   ...
   <tr>  <td> <h3>  &nbsp  &nbsp   &nbsp <%=rs.getInt(1) %>.&nbsp<%=rs.getString(2)%>&nbsp <a href="editN.jsp?id=<%=rs.getInt(1)%>"> <p align="right">EDIT &nbsp </p> </a>    </h3> </td>  </tr>  
