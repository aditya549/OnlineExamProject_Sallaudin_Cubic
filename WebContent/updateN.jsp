...
try{
	...
	PreparedStatement pst=cn.prepareStatement("update DotnetQ set questions=?, option1=?,option2=?, option3=? ,option4=? ,answer=? where qno=?");
	pst.setString(1, qu);
	pst.setString(2, o1);
	pst.setString(3, o2);
	pst.setString(4, o3);
	...
	if(i==1){
		...
		<script> 
	    	 ...
	    	 <% 
		RequestDispatcher  rd =request.getRequestDispatcher("viewNetQ.jsp");
