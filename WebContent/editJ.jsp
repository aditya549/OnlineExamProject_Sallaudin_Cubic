...
<bdd>
<h2>  <u> JavaQ Questions  </u> </h2>
</div>

<table border="2px" width="150%" color="blue">

<%
try{
int qn=Integer.parseInt(request.getParameter("id"));
Class.forName( "oracle.jdbc.driver.OracleDriver");
Connection conn=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","Sallauddin","super");
PreparedStatement pst=conn.prepareStatement("select * from JavaQ where qno=? ");
pst.setInt(1, qn);
ResultSet rs=pst.executeQuery();
 while(rs.next())
 {
%>
<form action="updateJ.jsp" method="post">
	
	
Question No.  <input type="text" name="qn" value="<%=rs.getInt(1) %>" readonly="readonly"><br> <br>
Question  &nbsp&nbsp &nbsp&nbsp&nbsp<input type="text" name="qu"  size="80%" value="<%=rs.getString(2) %>"><br><br>
Option 1  &nbsp&nbsp &nbsp&nbsp&nbsp<input type="text" name="o1"  size="80%" value="<%=rs.getString(3) %>"><br><br>
Option 2  &nbsp&nbsp &nbsp&nbsp&nbsp<input type="text" name="o2" size="80%"  value="<%=rs.getString(4) %>"><br><br>
Option 3  &nbsp&nbsp &nbsp&nbsp&nbsp<input type="text" name="o3"  size="80%" value="<%=rs.getString(5) %>"><br><br>
Option 4  &nbsp&nbsp &nbsp&nbsp&nbsp<input type="text" name="o4"  size="80%" value="<%=rs.getString(6) %>"><br><br>
	
Answer &nbsp  &nbsp&nbsp &nbsp&nbsp<input type="text" name="ans" size="80%"  value="<%=rs.getString(7) %>"><br><br>
...
%>
<br>
 &nbsp&nbsp &nbsp&nbsp&nbsp &nbsp&nbsp &nbsp&nbsp&nbsp &nbsp&nbsp &nbsp&nbsp&nbsp &nbsp&nbsp &nbsp&nbsp&nbsp<input type="submit" value="UPDATE">
</form>
...
</p>    		      <ul class="social-nav icons_2 clearfix">
