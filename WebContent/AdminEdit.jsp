...
Name  &nbsp&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="username"  size="20%" readonly="readonly" value="<%=rs.getString(1) %> "><br><br>
Password  &nbsp&nbsp&nbsp<input type="text" name="pwdd"  size="20%"  value="<%=rs.getString(2) %>"><br><br>
Email  &nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp<input type="text" name="mail"  size="20%" value="<%=rs.getString(3) %>"><br><br>
Admin Id   &nbsp&nbsp&nbsp<input type="text" name="id"  size="20%" value="<%=rs.getInt(4) %>"><br><br>
