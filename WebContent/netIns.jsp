...
<nav class="navbar navbar-default" role="navigation">
	<div class="container">
	    <div class="navbar-header">
	        ...
	        <a class="navbar-brand" href="index.jsp">Learn Tutorial</a>
	    </div>
	    <!--/.navbar-header-->
	    <div class="navbar-collapse collapse" id="bs-example-navbar-collapse-1" style="height: 1px;">
	        <ul class="nav navbar-nav">
		        ...
		        <li class="dropdown">
		            <a href="netProfile.jsp"><i class="fa fa-user"></i><span>Profile</span></a>
		        </li>
		    </ul>
	    </div>
...
<p><button type="button" > <a href="dotnetPage.jsp" >Ready to Start</a> </input><p>
